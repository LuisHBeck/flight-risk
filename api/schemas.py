...
class ShapExplanationRequest(BaseModel):
    """Request body for POST /explain/shap."""

    shap_explanation: ShapExplanation
    delay_proba: float | None = Field(
        default=None, ge=0.0, le=1.0,
        description="Delay probability returned by /predict. Enriches the LLM prompt context.",
    )
    airline_icao: str | None = Field(default=None, description="Airline ICAO code.")
    origin_icao: str | None = Field(default=None, description="Origin airport ICAO code.")
    destination_icao: str | None = Field(default=None, description="Destination airport ICAO code.")


class ExplanationResponse(BaseModel):
    """Response body for POST /explain/shap."""

    explanation: str = Field(..., description="PT-BR natural-language explanation generated by the LLM.")
